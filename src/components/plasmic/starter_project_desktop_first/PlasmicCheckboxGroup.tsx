...
import Checkbox from "../../Checkbox"; // plasmic-import: YLYaw-EwG4h7/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: jlZ1vDpvOf6V/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__o951C)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__wPl7C)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__q5V2S)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__r8KgM)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
