...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: n-E5l1uK1szr/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__sxZc)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___9Qshj)}>
            <div
              className={classNames(
                projectcss.all,
