...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 9U_JnbRxU1zI/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__jxFmq)}>
        <div className={classNames(projectcss.all, sty.freeBox___5VSf)} />
      </div>
      {renderPlasmicSlot({
