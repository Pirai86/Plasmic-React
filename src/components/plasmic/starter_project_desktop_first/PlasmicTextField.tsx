...
import Label from "../../Label"; // plasmic-import: 0BHcOzBB9hrn/component
import TextInput from "../../TextInput"; // plasmic-import: ryhLKTJIVnOu/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: iXXKNOeCEZEY/component
import Description from "../../Description"; // plasmic-import: Qw1HepUnoRcl/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: D0l3H5SL43hH/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__dCgMz, {
          [sty.freeBoxiconEnd__dCgMzz4UZ4]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__dCgMZohiAd]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__dCgMzpXv5T]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___2U6Br, {
            [sty.freeBoxiconStart___2U6BRohiAd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___2U6BrpXv5T]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___1EyGt)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__hVs2D, {
            [sty.freeBoxiconEnd__hVs2DZ4UZ4]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__hVs2DohiAd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__pjDr8)}
                role={"img"}
              />
            ),
