...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: YLYaw-EwG4h7/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: wHrIXBioqNu_/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: -Ciwqo0PhmNY/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__f5Fkc)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__llerc)}
            role={"img"}
          />
        ) : null}
      </div>
