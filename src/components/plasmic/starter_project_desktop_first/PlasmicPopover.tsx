...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: LpcYWDdLNg7M/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: mjd8C-Mk9iSb/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__wn4Q)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button___5XTi8)}
            label={"Open Popover"}
          />
        ),
