...
import MenuPopover from "../../MenuPopover"; // plasmic-import: McqzN1OeXZvF/component
import MenuItem from "../../MenuItem"; // plasmic-import: n-E5l1uK1szr/component
import MenuSection from "../../MenuSection"; // plasmic-import: cJnjLFsEKEns/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: GpSWt4YgohKO/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__zK8R)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
