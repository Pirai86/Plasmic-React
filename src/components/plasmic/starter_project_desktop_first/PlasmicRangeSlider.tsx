...
import SliderThumb from "../../SliderThumb"; // plasmic-import: 3ysz-6Mf9yPC/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: pIIVw8BSexnM/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__bJdxe)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__sr9Ol)}>
        <div
